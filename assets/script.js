...
//links
document.getElementById("github").addEventListener("click", () => window.location.href = "https://github.com/Truthy1441")
document.getElementById("youtube").addEventListener("click", () => window.location.href = "https://www.youtube.com/channel/UCGFL6J7dXvAHO7WBcPlnWEg")
document.getElementById("discord").addEventListener("click", () => {
    navigator.clipboard.writeText("Truthy#4163")
